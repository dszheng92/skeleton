...
public class ReceiptController {
    ...
    public int createReceipt(@Valid @NotNull CreateReceiptRequest receipt) {
        return receipts.insertReceipt(receipt.merchant, receipt.amount);
    }
    ...
    public List<ReceiptResponse> getReceipts() {
        ...
        return receiptRecords.stream()
                ...
                .map(receiptResponse -> ReceiptController.addTags(receiptResponse, tags.tagsReceiptFromId(receiptResponse.getId())))
                .collect(toList());
    }
